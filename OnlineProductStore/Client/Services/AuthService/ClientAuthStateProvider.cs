...
namespace OnlineProductStore.Client.Services.AuthService
{
    public class ClientAuthStateProvider : AuthenticationStateProvider
    {
        ...
        public ClientAuthStateProvider(ILocalStorageService localStorage, HttpClient httpClient) 
        {
        ...
        {
            string authToken = await _localStorage.GetItemAsync<string>("jwt-token");
